...
<body id="nhanvien">
	...
	<footer>
		...
		<div class="lk">
			<p>Liên Kết</p>
			<ul>
				<li><a class="trang-chu"  href="/demospringmvc/admin/trang-chu">Trang Chủ</a>        </li>     
				<li><a class="chitietgoitap" href="/demospringmvc/chitietgoitap">Chi Tiết gói Tập</a>  </li> 
				<li><a class="dangkyloptap" href="/demospringmvc/dangkyloptap">Đăng Ký lớp Tập</a>    </li> 
				<li><a class="giaodich" 		href="/demospringmvc/giaodich">Giao Dịch</a> </li> 
				<li><a class="khachhang" 		href="/demospringmvc/khachhang">Khách Hàng</a>  </li> 
				<li><a class="nhanvien" 		href="/demospringmvc/nhanvien">Nhân Viên</a> </li>                   
				<li><a class="thietbi" 		href="/demospringmvc/admin/thietbi">Thiết Bị</a>  </li>              
			</ul>
		</div>
		<div class="ht">
			<p>Hỗ Trợ</p>
