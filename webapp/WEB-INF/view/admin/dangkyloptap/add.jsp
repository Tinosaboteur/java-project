...
<h1>Thêm Đăng Ký Lớp Tập</h1>
<form action="/demospringmvc/dangkyloptap/add" method="post">
    ...
    <label for="scheduleID">Lớp tập:</label>
    <select id="scheduleID" name="scheduleID">
        <c:forEach var="itemlt" items="${lichtap}">
            <option value="${itemlt.scheduleID}">${itemlt.scheduleID}</option>
        </c:forEach>
    </select>
