...
<body id="chitietgoitap">
	...
	<div class="back-home">
        ...
        <a href="/demospringmvc/admin/chitietgoitap/add"><i style="float: right;" class='fa-sharp fa-solid fa-circle-plus fa-2x  fa-beat' style='color:#000000'></i></a>
        <a href="/demospringmvc/admin/chitietgoitap/update"><i style="float: right; margin-top: 0.2rem; margin-right: 1.7rem" class='fa-sharp fa-solid fa-pen fa-2x  fa-beat' style='color:#000000'></i></a>
    </div>
    ...
    <c:forEach var="item" items="${chitietgoitap}">
        ...
        <h2 class="package-ID">ID: ${item.subscriptionID}</h2>
            ...
            <p class="package-info">Ngày bắt đầu: <span>${item.startDate}</span></p>
            <p class="package-info">Ngày kết thúc: <span>${item.endDate}</span></p>
        </div>
    </c:forEach>
</section>
