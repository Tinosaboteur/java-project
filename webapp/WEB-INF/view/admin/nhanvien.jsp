...
<body id="nhanvien">
	...
	<div class="back-home">
        ...
        <a href="/demospringmvc/admin/nhanvien/add"><i style="float: right;" class='fa-sharp fa-solid fa-circle-plus fa-2x  fa-beat' style='color:#000000'></i></a>
        <a href="/demospringmvc/admin/nhanvien/update"><i style="float: right; margin-top: 0.2rem; margin-right: 1.7rem" class='fa-sharp fa-solid fa-pen fa-2x  fa-beat' style='color:#000000'></i></a>
    </div>
