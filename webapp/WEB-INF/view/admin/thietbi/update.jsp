...
<div>
    ...
    <c:forEach var="item" items="${thietbi}">
        <div class="equipment-card">
            ...
            <form action="/demospringmvc/thietbi/update" method="post">
                <input type="hidden" id="equipmentID" name="equipmentID" value="${item.equipmentID}">
                ...
                <input type="text" id="img" name="img" value="${item.img}"><br>
