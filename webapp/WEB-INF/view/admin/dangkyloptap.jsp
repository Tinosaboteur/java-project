...
<body id="dangkyloptap">
	...
	<div class="back-home">
        ...
        <a href="/demospringmvc/admin/dangkyloptap/add"><i style="float: right;" class='fa-sharp fa-solid fa-circle-plus fa-2x  fa-beat' style='color:#000000'></i></a>
        <a href="/demospringmvc/admin/dangkyloptap/update"><i style="float: right; margin-top: 0.2rem; margin-right: 1.7rem" class='fa-sharp fa-solid fa-pen fa-2x  fa-beat' style='color:#000000'></i></a>
    </div>
